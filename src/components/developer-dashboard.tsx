...
export function DeveloperDashboard() {
  ...
  async function register(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setName(""); setDescription(""); setOfferings(""); setSpecialties(""); setJurisdictions(""); setMetadataUri(""); setEndpointUrl("");
